  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 py-8 text-white">
        <h1 className="text-3xl font-bold mb-4">Brain Tumour Detection</h1>
        <div className="grid grid-cols-2 gap-4 mb-8">
          {/* Sample images */}
          <div className="border p-4">
            <h2 className="text-xl font-semibold mb-2">Select Sample Image:</h2>
            <div className="flex flex-wrap">
              <img
                src="sample_image_1.jpg" // Replace with your sample image URL
                alt="Sample Image 1"
