                      ...
                      <div className='w-full flex-col justify-center'>
                        {tumourFound ? (
                          <div className='w-full flex-col justify-center'>
                            ...
                            <p className="text-lg font-medium font-['Poppins'] text-center text-white">Confidence Scores: {confidenceScores.join(', ')}</p>
                          </div>
                        ) : (
                          <p className="text-lg font-medium font-['Poppins'] text-center text-white">No Brain Tumour Found.</p>
                        )}
                      </div>
                    )}
                  </div>
