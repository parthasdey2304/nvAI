...
function Detection() {
  ...
  return (
    <div>
      ...
      <div className="w-full h-[800px] flex justify-center container mx-auto px-4 py-8 md:pt-52">
        <h1 className="text-5xl text-center font-['Jersey'] text-white font-bold mb-4">Brain Tumour Detection</h1>
        <div>
